...
//		String[] str_arr = split("abc|ef|ght", "|");
//		for(int i=0; i<str_arr.length; i++) {
//			System.out.println(">>>>>>>" + str_arr[i]);
//		}
		
//		System.out.println(">>>>>>>" + getPadString("aceof", 10, "@", 1));
		
		System.out.println(">>>>>>>" + dateDash("2105"));
		System.out.println(">>>>>>>" + dateDash("202105"));
		System.out.println(">>>>>>>" + dateDash("20210530"));
	}
